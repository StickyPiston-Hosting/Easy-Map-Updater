...
- `dp.attribute`: In 1.21, dying no longer resets your base attributes. This action adds a data pack to your world that simulates the old attribute behavior.
- `dp.lock_fixer`: In 1.21.2, locked containers were changed to check for an item predicate instead of a custom name string. This action adds a data pack to your world that will modify item names to open the updated containers.
